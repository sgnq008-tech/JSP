 ...
 * Generated at: 2026-09-14 04:21:49 UTC
...
public final class usingDBCP_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.jdbc.TempMemberVO");
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("\r\n");
      com.jdbc.TempMemberDAO dao = null;
      dao = (com.jdbc.TempMemberDAO) _jspx_page_context.getAttribute("dao", javax.servlet.jsp.PageContext.PAGE_SCOPE);
      if (dao == null){
        dao = new com.jdbc.TempMemberDAO();
    ...
    int counter = (vlist != null) ? vlist.size() : 0;
      ...
      out.write("<title>DBCP를 이용한 데이터베이스</title>\r\n");
      out.write("<link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\">\r\n");
      out.write("</head>\r\n");
      out.write("<body bgcolor=\"#ffffcc\">\r\n");
      out.write("<h2>DBCP를 사용한 데이터베이스</h2>\r\n");
    ...
    if (vlist != null && !vlist.isEmpty()) {
      ...
      out.write("\r\n");
      out.write("    <!-- 데이터 행 (헤더와 동일하게 9칸) -->\r\n");
      out.write("    <tr>\r\n");
      out.write("        <td>");
      out.print( vo.getId() );
      out.write("</td>\r\n");
      out.write("        <td>");
      out.print( vo.getPasswd() );
      out.write("</td>\r\n");
      out.write("        <td>");
      out.print( vo.getName() );
      out.write("</td>\r\n");
      out.write("        <td>");
      out.print( vo.getMem_num1() );
      out.write("</td>\r\n");
      out.write("        <td>");
      out.print( vo.getMem_num2() );
      out.write("</td>\r\n");
      out.write("        <td>");
      out.print( vo.getE_mail() );
      out.write("</td>\r\n");
      out.write("        <td>");
      out.print( vo.getPhone() );
      out.write("</td>\r\n");
      out.write("        <!-- 우편번호와 주소를 한 칸에 묶어서 출력 -->\r\n");
      out.write("        <td>");
      out.print( (vo.getZipcode() != null ? vo.getZipcode() : "") + " " + (vo.getAddress() != null ? vo.getAddress() : "") );
      out.write("</td>\r\n");
      out.write("        <td>");
      out.print( vo.getJob() );
      out.write("</td>\r\n");
      ...
      out.write("\r\n");
      out.write("    <tr>\r\n");
      out.write("        <td colspan=\"9\" align=\"center\">등록된 회원 정보가 없습니다.</td>\r\n");
      out.write("    </tr>\r\n");
